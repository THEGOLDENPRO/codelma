...
# Commands
# -------------
@bot.slash_command(name="solve", description="🧩 Begin your puzzle.", guild_ids=[863416692083916820, 883443159798018078]) # Added my guild id for testing, add yours too if you would like to test this command.
async def solve(
